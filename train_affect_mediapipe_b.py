...
from models.emotion_hyp_affect_mediapipe_v3 import pyramid_trans_expr
...
def run_training():
    ...
    if args.dataset == "rafdb":
        ...
        model = pyramid_trans_expr(img_size=224, num_classes=num_classes, type=args.modeltype, freeze=args.freeze, mediapipe_patch_size=24)
