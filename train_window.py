...
def run_training():
    ...
    if args.dataset == "rafdb":
        ...
        datapath = '/home/Dataset/customer_ori'
        num_classes = 3
        train_dataset = AffectDatasetWindow_facecrop(datapath, train=True, window_size=args.window_size, stride=args.stride, transform=data_transforms)
        val_dataset = AffectDatasetWindow_facecrop(datapath, train=False, window_size=args.window_size, stride=args.stride, transform=data_transforms_val)
        model = pyramid_trans_expr_window(img_size=224, num_classes=num_classes, window_size=args.window_size, type=args.modeltype)
    ...
    for i in range(1, args.epochs + 1):
        ...
        for img_frames, targets in train_bar:
        ...
        with torch.no_grad():
            ...
            for img_frames, targets in test_bar:
