...
from models.emotion_hyp_test_stage1 import pyramid_trans_expr
...
def parse_args():
    ...
    parser.add_argument('-c', '--checkpoint', type=str, default='./models/pretrain/pyramid_fuse_acc0914.pth', help='Pytorch checkpoint file path')
...
def test():
    ...
    if args.dataset == "rafdb":
        ...
        model = pyramid_trans_expr(img_size=224, num_classes=num_classes, type=args.modeltype, freeze=True)
