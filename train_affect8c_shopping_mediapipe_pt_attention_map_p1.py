...
from models.emotion_hyp_affect_mediapipe_pt_attention_map_p1 import pyramid_trans_expr as pyramid_trans_expr_attention_map
...
def parse_args():
    ...
    parser.add_argument('--remark', type=str, default="remark", help='attention map Phase1')
    
    # 新增提取權重的參數
    parser.add_argument('--extract_weights', action='store_true', default=True, help='Extract and save global attention weights after training/loading checkpoint.')
