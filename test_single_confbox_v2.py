...
def parse_args():
    ...
    parser.add_argument('--image_folder', type=str, default='/home/Dataset/customer_ori2/out/let s go/let s go-16', help='Path to image folder')    # /home/Dataset/customer_ori2/out/A Simple Shopping Haul Turned Into Online Drama/Haul-4
    parser.add_argument('--checkpoint_single', type=str, default='./checkpoint/20260128-100001/epoch25_acc0.8408.pth', help='Path to model')
