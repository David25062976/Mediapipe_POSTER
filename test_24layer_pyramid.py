...
from models.emotion_hyp_2layer_pyramid import pyramid_trans_expr as a2layer_pyramid_trans_expr
from models.emotion_hyp_4layer_pyramid import pyramid_trans_expr as a4layer_pyramid_trans_expr
...
def parse_args():
    ...
    parser.add_argument('-c', '--checkpoint', type=str, default='checkpoint/affectnet8class_2layer_pyramid.pth', help='Pytorch checkpoint file path')
...
def test():
    ...
    if args.dataset == "rafdb":
        ...
        if args.checkpoint == "checkpoint/affectnet8class_2layer_pyramid.pth" :
            model = a2layer_pyramid_trans_expr(img_size=224, num_classes=num_classes, type=args.modeltype)
        elif args.checkpoint == "checkpoint/affectnet8class_4layer_pyramid.pth" :
            model = a4layer_pyramid_trans_expr(img_size=224, num_classes=num_classes, type=args.modeltype)
        else :
            model = pyramid_trans_expr(img_size=224, num_classes=num_classes, type=args.modeltype)
