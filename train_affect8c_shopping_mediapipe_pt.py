...
def parse_args():
    ...
    parser.add_argument('--mediapipe_points', type=int, default=49, help='49 or 196')
...
def run_training():
    ...
    if args.dataset == "rafdb":
    ...
    elif args.dataset == "affectnet8class_PD":
        ...
        # test_data_dir = './data/AffectNet_customer_2class/test_set_mediapipe'
        # test_landmarks_db = './data/AffectNet_customer_2class/test_set_mediapipe_landmarks_all.pt'

        train_data_dir = './data/AffectNet8C_PD/train_set'
        train_landmarks_db = './data/AffectNet8C_PD/train_set_landmarks_all.pt'
        valid_data_dir = './data/AffectNet8C_PD/valid_set'
        valid_landmarks_db = './data/AffectNet8C_PD/valid_set_landmarks_all.pt'
        test_data_dir = ''
        
        class_names = ['Neutral', 'Happy', 'Sad', 'Surprise', 'Fear', 'Anger', 'Disgust', 'PD']
    ...
    elif args.dataset == "affectnet8class_PFED5":
        train_data_dir = './data/AffectNet8C_PFED5/train_set'
        train_landmarks_db = './data/AffectNet8C_PFED5/train_set_landmarks_all.pt'
        valid_data_dir = './data/AffectNet8C_PFED5/valid_set'
        valid_landmarks_db = './data/AffectNet8C_PFED5/valid_set_landmarks_all.pt'
        test_data_dir = './data/AffectNet8C_PFED5/test_set'
        test_landmarks_db = './data/AffectNet8C_PFED5/test_set_landmarks_all.pt'
    ...
    elif args.dataset == "PFED5":
        train_data_dir = './data/PFED5/train_set'
        train_landmarks_db = './data/PFED5/train_set_landmarks_all.pt'
        valid_data_dir = './data/PFED5/valid_set'
        valid_landmarks_db = './data/PFED5/valid_set_landmarks_all.pt'
        test_data_dir = './data/PFED5/test_set'
        test_landmarks_db = './data/PFED5/test_set_landmarks_all.pt'
        ...
        if args.exp_model == '1-1':
            model = pyramid_trans_expr_1_1(img_size=224, num_classes=num_classes, type=args.modeltype, freeze=args.freeze, mediapipe_points=args.mediapipe_points, mediapipe_patch_size=args.mediapipe_patch_size)
        elif args.exp_model == '1-2':
            model = pyramid_trans_expr_1_2(img_size=224, num_classes=num_classes, type=args.modeltype, freeze=args.freeze, mediapipe_points=args.mediapipe_points, mediapipe_patch_size=args.mediapipe_patch_size)
        elif args.exp_model == '1-3':
            model = pyramid_trans_expr_1_3(img_size=224, num_classes=num_classes, type=args.modeltype, freeze=args.freeze, mediapipe_points=args.mediapipe_points, mediapipe_patch_size=args.mediapipe_patch_size)
        elif args.exp_model == '1-4':
            model = pyramid_trans_expr_1_4(img_size=224, num_classes=num_classes, type=args.modeltype, freeze=args.freeze, mediapipe_points=args.mediapipe_points, mediapipe_patch_size=args.mediapipe_patch_size)
        elif args.exp_model == '1-5':
            model = pyramid_trans_expr_1_5(img_size=224, num_classes=num_classes, type=args.modeltype)
        else:
            model = pyramid_trans_expr(img_size=224, num_classes=num_classes, type=args.modeltype, freeze=args.freeze, mediapipe_points=args.mediapipe_points, mediapipe_patch_size=args.mediapipe_patch_size)
        ...
        test_data_dir = './data/AffectNet_customer/test_set/test_set_AffectNet'
        test_landmarks_db = './data/AffectNet_customer/test_set/test_set_AffectNet_landmarks_all.pt'
